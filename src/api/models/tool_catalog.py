...
class ToolCatalogItem(BaseModel):
    ...
    name: str = Field(..., description="Stable tool name used for function calling and settings storage")
    ...
    enabled_by_default: bool = Field(..., description="Whether the tool is enabled by default in project settings")
...
class ToolCatalogGroup(BaseModel):
    ...
    description_i18n_key: str = Field(..., description="Frontend i18n key for the group description")
