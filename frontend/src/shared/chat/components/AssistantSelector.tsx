...
export const AssistantSelector: React.FC<AssistantSelectorProps> = ({
  ...
  const ToolbarIcon = getAssistantIcon(currentAssistant?.icon);
  ...
  return (
    <div data-name="assistant-selector-root">
      ...
      <button
        ...
        title={`${displayName}${currentAssistant?.description ? ' - ' + currentAssistant.description : ''}`}
      >
                  ...
                  >
                    <div className="flex items-center gap-2">
                      {(() => {
                        ...
                        return <ItemIcon className="w-4 h-4 shrink-0 text-gray-500 dark:text-gray-400" />;
                      })()}
                      ...
                      <span
                        className="text-xs text-gray-400 dark:text-gray-500 truncate ml-auto max-w-[120px]"
                        title={assistant.model_id}
                      >
                        {assistant.model_id}
                      </span>
                      {isSelected && (
